  ...
  return (
    <div className="min-h-screen max-w-screen-2xl mx-auto overflow-hidden">
      ...
      <section className="bg-gradient-to-r from-[#F7F8FC] to-[#E3E6EE] text-black py-12 sm:py-16 px-4 sm:px-6 lg:px-10">
        {/* Branding Title */}
        <h1
          className="text-3xl sm:text-4xl md:text-5xl uppercase text-center text-black mb-8 sm:mb-12 font-bold"
        ...
        <div className="py-8 sm:py-10">
          <h1 className="text-3xl sm:text-4xl text-center text-[#ad1f22] font-pinyon capitalize mb-6 sm:mb-8">
            Blond Bakery
          </h1>
          <Swiper
            spaceBetween={20}
